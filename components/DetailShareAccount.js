...
class DetailShareAccount extends Component{
    transaction(){
        this.props.navigator.push({
                   component: require('./Transaction')
         })
     }

    bonusShares(){
         this.props.navigator.push({
               component: require('./BonusShares')
         })
     }
            ...
            <View style={Style.container}>
                <View style={Style.title1}>
                    ...
                    <View style={Style.title12}>
                        <Text style={Style.text1}>DETAIL SHARE ACCOUNT 1</Text>
                    </View>

                </View>
                <View style={Style.title2}></View>
                <TouchableOpacity style={Style.button} onPress={() => {this.transaction()}}>
...
module.exports = DetailShareAccount;
