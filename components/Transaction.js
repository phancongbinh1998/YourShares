...
class Transaction extends Component{
    detailTransaction(){
            this.props.navigator.push({
                  component: require('./DetailTransaction')
            })
        }
            ...
            <View style={Style.container}>
                <View style={Style.title1}>
                    ...
                    <View style={Style.title12}>
                        <Text style={Style.text1}>TRANSACTION</Text>
                    </View>

                </View>
                <View style={Style.title2}></View>
                <TouchableOpacity style={Style.button} onPress={() => {this.detailTransaction()}}>
                            <Text style={Style.buttonText}>Transaction 1</Text>
                </TouchableOpacity>
