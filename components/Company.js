...
class Company extends Component{
    detailCompany(){
            this.props.navigator.push({
                  component: require('./DetailCompany')
            })
        }
            ...
            <View style={Style.container}>
                <View style={Style.title1}>
                    ...
                    <View style={Style.title12}>
                        <Text style={Style.text1}>COMPANY</Text>
                    </View>

                </View>
                <View style={Style.title2}></View>
                <TouchableOpacity style={Style.button} onPress={() => {this.detailCompany()}}>
                            <Text style={Style.buttonText}>COMPANY 1</Text>
                </TouchableOpacity>
