...
class BonusShares extends Component{
            ...
            <View style={Style.container}>
                <View style={Style.title1}>
                    ...
                    <View style={Style.title12}>
                        <Text style={Style.text1}>BONUS SHARES</Text>
                    </View>

                </View>
                <View style={Style.title2}></View>
                <Text style={Style.buttonText}>DETAIL YOUR BONUS SHARES</Text>
