...
class DetailCompany extends Component{
    ground(){
        this.props.navigator.push({
                   component: require('./Ground')
         })
     }

    shareAccount(){
         this.props.navigator.push({
               component: require('./ShareAccount')
         })
     }
            ...
            <View style={Style.container}>
                <View style={Style.title1}>
                    ...
                    <View style={Style.title12}>
                        <Text style={Style.text1}>DETAIL COMPANY 1</Text>
                    </View>

                </View>
                <View style={Style.title2}></View>
                <TouchableOpacity style={Style.button} onPress={() => {this.ground()}}>
                            <Text style={Style.buttonText}>GROUND</Text>
                </TouchableOpacity>
                <TouchableOpacity style={Style.button} onPress={() => {this.shareAccount()}}>
                            <Text style={Style.buttonText}>SHARE ACCOUNT</Text>
                </TouchableOpacity>
